module Documents
  class YesNoValue < FieldValue
    ...
    def allows_na? = _configuration.dig("allows_na") || false

    def invert_colours? = _configuration.dig("invert_colours") || false

    def score = configuration.dig("scores", value) || default_score
    ...
    private def _configuration = configuration || {}

    private def default_score = (value == "y") ? 1 : 0
